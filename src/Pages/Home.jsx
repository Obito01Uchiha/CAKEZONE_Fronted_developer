  ...
  return (
    ...
    <div class="container-fluid pt-5">
        <div class="container">
            ...
            <div class="row gx-5">
                <div class="col-lg-5 mb-5 mb-lg-0" style={{minHeight: "400px"}}>
    ...
    {/* <!-- Service Start --> */}
    <div class="container-fluid service position-relative px-5 mt-5" style={{marginBottom: "135px"}}>
        <div class="container">
            <div class="row g-5">
        ...
        <div class="container py-5">
            <div class="row gx-5 justify-content-center">
                <div class="col-lg-7 text-center">
                    <div class="section-title position-relative text-center mx-auto mb-4 pb-3" style={{maxWidth: "600px"}}>
